...
handler = {
  ...
  main: function() {
    var HEIGHT, R, WIDTH, X0, Y0, allYobasStopped, bumpedYoba, dFi, dS, fi, i, m1, m2, oL, oR, scriptIntervalID, v1, v2, y, yL, yR, yb, yobaIndex, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3;
    ...
    for (yobaIndex = _i = 0, _len = _ref.length; _i < _len; yobaIndex = ++_i) {
      ...
      if (bumpedYoba) {
        ...
        v1 = y.speed;
        v2 = bumpedYoba.speed;
        _ref2 = handler.getSpeedsAfterBump(m1, v1, m2, v2), dS = _ref2[0], bumpedYoba.speed = _ref2[1];
        y.startSpeek();
